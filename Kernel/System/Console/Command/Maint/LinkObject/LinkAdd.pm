...
package Kernel::System::Console::Command::Maint::LinkObject::LinkAdd;
...
sub Configure {
    ...
    $Self->Description('Add link for objects.');
    $Self->AddOption(
        Name        => 'source-object',
    ...
    $Self->AddOption(
        Name        => 'state',
        Description => "The type for the link (e.g. 'Valid', 'Temporary').",
        Required    => 1,
        HasValue    => 1,
        ValueRegex  => qr/.*/,
    );
...
sub Run {
    ...
    $Self->Print("<yellow>Add link for objects...</yellow>\n\n");
